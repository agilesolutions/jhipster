...
logSummary() {
    echo ""
        ...
        echo "Gateway - http://ui.office.35.184.190.237.nip.io"
        echo "Zipkin - http://zipkin.istio-system.35.184.190.237.nip.io"
        echo "Grafana - http://grafana.istio-system.35.184.190.237.nip.io"
        echo "Kiali - http://kiali.istio-system.35.184.190.237.nip.io"
        echo "#####################################################"
}
...
default() {
    ...
    kubectl apply -f leave-${suffix}/
    kubectl apply -f meeting-${suffix}/
