...
import ch.agilesolutions.jhipster.meeting.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link ch.agilesolutions.jhipster.meeting.domain.MeetingRoom}.
 */
@RestController
@RequestMapping("/api")
public class MeetingRoomResource {
    ...
    public ResponseEntity<MeetingRoom> updateMeetingRoom(@Valid @RequestBody MeetingRoom meetingRoom) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, meetingRoom.getId()))
            .body(result);
    }
