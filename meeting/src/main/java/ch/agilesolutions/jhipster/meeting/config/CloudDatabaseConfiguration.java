package ch.agilesolutions.jhipster.meeting.config;
...
@Configuration
@EnableMongoRepositories("ch.agilesolutions.jhipster.meeting.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("ch.agilesolutions.jhipster.meeting.config.dbmigrations");
