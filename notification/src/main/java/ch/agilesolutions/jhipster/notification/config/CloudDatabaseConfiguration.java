package ch.agilesolutions.jhipster.notification.config;
...
@Configuration
@EnableMongoRepositories("ch.agilesolutions.jhipster.notification.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("ch.agilesolutions.jhipster.notification.config.dbmigrations");
