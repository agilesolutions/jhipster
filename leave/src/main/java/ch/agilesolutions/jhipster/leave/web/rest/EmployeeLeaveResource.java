...
/**
 * REST controller for managing {@link ch.agilesolutions.jhipster.leave.domain.EmployeeLeave}.
 */
@RestController
@RequestMapping("/api")
public class EmployeeLeaveResource {
    ...
    public ResponseEntity<EmployeeLeave> updateEmployeeLeave(@Valid @RequestBody EmployeeLeave employeeLeave) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, employeeLeave.getId()))
            .body(result);
    }
