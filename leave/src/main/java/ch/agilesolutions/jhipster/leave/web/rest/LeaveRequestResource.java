...
import ch.agilesolutions.jhipster.leave.service.LeaveRequestService;
import ch.agilesolutions.jhipster.leave.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link ch.agilesolutions.jhipster.leave.domain.LeaveRequest}.
 */
@RestController
@RequestMapping("/api")
public class LeaveRequestResource {
    ...
    public ResponseEntity<LeaveRequest> updateLeaveRequest(@Valid @RequestBody LeaveRequest leaveRequest) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, leaveRequest.getId()))
            .body(result);
    }
