package ch.agilesolutions.jhipster.ui.config;
...
@Configuration
@EnableMongoRepositories("ch.agilesolutions.jhipster.ui.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("ch.agilesolutions.jhipster.ui.config.dbmigrations");
